      ...
      >
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              {
                // put adding contact here including the button and textarea (simply cut and paste) but make sure you have a button to open this modal
                // get an icon for the upload video modal and make sure you can't send a message if a contact wasn't chosen
                // also try to understand why the other pfps won't show
                // and make the existing modal interfaces prettier
              }
            </div>
          </div>
        </div>
